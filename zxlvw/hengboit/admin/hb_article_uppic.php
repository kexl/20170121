...
$sqlstr="select pic from ".$hbpre."article where id=$id";
...
//	  exit();
  ...
  $sqlstr="update ".$hbpre."article set pic='$dbfiles' where id=$id";
		  }
	  mysql_query($sqlstr);
...
if(isset($_GET['del'])){
  $sqlstr="update ".$hbpre."article set pic='' where id=$id";
