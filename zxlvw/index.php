<?php
	include('hengboit/include/config.php');
?>
	<!DOCTYPE html>
	<html>
	<head>
		...
		<meta name="keywords" content="<?php echo $wkwd; ?>" />
		<meta name="description" content="<?php echo $wdescript;?>" />
	</head>
	...
	<body>
				...
				<div class="fl">
					...
					<div class="fr search">
						<form name="" method="post" action="">
							...
							<input type="submit" name="" id="" value="搜 索" class="btn back_e5004f fl" />
						</form>
						<ol>
							<li><a href="#">欧洲</a></li>
							<li><a href="#">金牌</a></li>
		...
		<div class="w1190 clearfix tab_box mAuto">
			<div class="left_menu back_fff clearfix">
				<div class="menu_box">
					<dl>
		...
		<div class="w1190  mAuto">
			...
			<div class="F2">
				...
				<div class="F2_center fl">
					<?php
						$sqlstr = 'select * from hb_article where cid=9 order by id desc limit 0,4';
						$query = mysql_query($sqlstr);
						while($rs=mysql_fetch_array($query)){
					?>
						<div class="pic_box ml10 mb10 fl">
							<div class="pic">
								<img src="img/20150303174623741.jpg" alt="" />
							</div>
							<p class="fl">
								<?php echo $rs['title']; ?>
							</p>
